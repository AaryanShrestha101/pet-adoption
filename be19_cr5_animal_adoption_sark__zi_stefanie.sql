...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2024 at 04:45 PM
...
CREATE TABLE `orders` (
  ...
  `living_condition` varchar(255) NOT NULL,
...
INSERT INTO `orders` (`id`, `animal_id_fk`, `user_id_fk`, `request_date`, `living_condition`, `previous_experience`, `adoption_reason`, `created_at`) VALUES
(1, 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', '0000-00-00 00:00:00'),
(2, 2, 9, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', '0000-00-00 00:00:00');
...
(22, NULL, 9, 7, '2024-05-15', 'qwertyuiopsdl;ahjflkjnc vasohuocgvrwqp', 'qwojieyjnriqowmp,rxcieqwqdasfcweqf', 'eqwUJDKL;HFKJASLN;MVIONDKLNionklvsd;ankfqwi', 4);
...
(9, 'Random', 'User', '209a1092a002d0f28bdb4117553e628cc46cfc0a9d180ff46325e4ccd464250a', 'khursanitar', 9821321, 'aaryanshrestha007@gmail.com', '6644c8e984d13.png', 'user');
