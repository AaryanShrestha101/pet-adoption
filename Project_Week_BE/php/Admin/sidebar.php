...
<hr style="border:1px solid; background-color:#94b9ff; border-color:#3B3131;">
    ...
    <a href="#productsizes"   onclick="showProductSizes()" ><i class="fa fa-th-list"></i> Requests</a>    
    <a href="#products"   onclick="showProductItems()" ><i class="fa fa-th"></i> Animals</a>
