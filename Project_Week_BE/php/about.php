    ...
    <div class="container d-flex flex-row flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap flex-xxl-nowrap justify-content-evenly gap-5">
        <div>
            <div class="mt-5 card card-body faqCard p-5 shadow">
                <div class="mb-3">
                    <p class="card-title"> Welcome to sanosansaar: <br> Where Hearts and Homes Unite </p>
                </div>
                <div class="mb-4 mt-4 text-center">
                    <p><b> Our Guideline: Don't Shop - Adopt! </b></p>
                </div>
                <div class="mb-3">
                    <p> At sanosansaar, our purpose is crystal clear: we are a passionate team of animal-loving Web Developers and Designers who have come together to create a meaningful bridge between animal shelters and those seeking to open their hearts and homes to a new furry friend. </p>
                </div>
                <div class="mb-3">
                    <p><b> Our Journey </b></p>
                </div>
                ...
                <div class="mb-3">
                    <p><b> Join the sanosansaar Journey </b></p>
                </div>
                <div class="mb-3">
                    <p> If you're an animal shelter seeking to collaborate or an individual excited to extend a warm welcome to a new companion, we invite you to be a part of the sanosansaar journey. Each adoption, every wagging tail, and the bonds formed remind us of the incredible power of empathy and care. </p>
                </div>
                <div class="mb-3">
                    <p> Thank you for making sanosansaar your platform of choice. Together, let's make the world a haven for our beloved four-legged friends. </p>
                </div>
                <div class="mb-3 mt-4">
                    <p> With heartfelt gratitude,</p>
                </div>
                <div class="mb-3">
                    <p> The sanosansaar Team </p>
                </div>
            </div>
        </div>
        <div class="mt-5">
